                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 0px 0;">
                                <p>
                                   <strong>Suivi de votre commande</strong>
                                </p> 
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 0px 0 0px 0;">
                                <p>
                                   Votre colis est en cour de livraison pour {{ $tracking->location }}
                                </p> 
                            </td>
                        </tr>
                    </table>
